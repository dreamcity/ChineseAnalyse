...
void TDIDF::getDocList(string dirstr, const char* outputfile)
{
...
void TDIDF::getWordMap(const char* inputfile)
{
	int val = 0;
	WordNum = 0;
	string strtmp;
...
void TDIDF::getTFData(const char* inputfile)
{
...
void TDIDF::getIDFData(const char* inputfile)
{
	string strtmp;
...
void TDIDF::saveIDFMap(const char* outputfile)
{
	ofstream outfile;
...
void TDIDF::loadIDFMap(const char* inputfile)
{
	 ifstream infile1;
